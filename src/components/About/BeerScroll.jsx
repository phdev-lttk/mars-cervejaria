...
const beers = [
    ...
    },
    {
        ...
        name: 'Sol da Tarde',
        desc: 'Leve, dourada e refrescante como o fim de um dia perfeito. Lúpulos florais e um corpo suave que convida ao próximo gole.',
        ibu: '18 IBU',
        abv: '4,8% ABV',
        tipo: 'Lager',
                ...
                <React.Fragment key={beer.id}>
                    ...
                    >
                        <div className="bs-card__left">
                            ...
                            <a className="bs-btn" href="/adquira-a-sua">Adquira a sua</a>
                        ...
                        <div
                            className="bs-card__right"
                            style={{ backgroundColor: beer.accent }}
                        >
                            <img
                                src={beer.img}
                                alt={beer.name}
