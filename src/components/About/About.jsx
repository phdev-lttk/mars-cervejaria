        ...
        <div className="about">
            ...
            <section className="hero-services">
                ...
                <h1 className="hero-headline">
                    Da seleção do malte<br />
                    ao<img className="hero-icon" src="/images/about/prancheta_forest.png" alt="" aria-hidden="true" /> último gole.
                </h1>
            </section>
            ...
            <section className="sobre-historia">
                <p>
                    ...
                    ela deve marcar a memória. Com a seleção rigorosa de maltes nobres,
                    lúpulos selecionados e um processo de fermentação artesanal meticuloso,
                    criamos receitas únicas para quem busca mais do que um gole. Porque em um mundo cheio de sabores comuns,
                    a Mars foi feita para se destacar e ser inesquecível.
                </p>
            </section>
